...
public class AppFragmenAdapter extends RecyclerView.Adapter<AppFragmenAdapter.AppViewHolder> {

    private List<AppEntity.ListBean> list = new ArrayList<>();
    private Context context;

    public AppFragmenAdapter(Context context) {
        this.context = context;
    }

    public void fillToData(List<AppEntity.ListBean> list) {
        this.list = list;
    ...
    public AppViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new AppViewHolder(LayoutInflater.from(context).inflate(R.layout.item_app_data, parent, false));
    }

    @Override
    public void onBindViewHolder(AppViewHolder holder, int position) {
        final AppEntity.ListBean listBean = list.get(position);
